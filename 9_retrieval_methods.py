...
#     search_kwargs={
#         "k": 3,
#         "score_threshold": 0.6  # Only return docs with similarity >= 0.7
#     }
# )

# docs = retriever.invoke(query)
# print(f"Retrieved {len(docs)} documents (threshold: 0.6):\n")
...
retriever = db.as_retriever(
    ...
    search_kwargs={
        ...
        "lambda_mult": 0.1  # 0=max diversity, 1=max relevance
    }
)

docs = retriever.invoke(query)
print(f"Retrieved {len(docs)} documents (λ=0.1):\n")
